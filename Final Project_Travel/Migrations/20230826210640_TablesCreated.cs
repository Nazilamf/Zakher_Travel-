    ...
    public partial class TablesCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartureLocations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ButtonText = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ButtonUrl = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ButtonBackgroundColor = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
